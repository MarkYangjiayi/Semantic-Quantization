...
# Added from feature_extractor.py
def mean_pixels(model_variant=None):
...
def preprocess_image_and_label(image,
  ...
  # Not augmented and return original when min and max are both 1.
  ...
  mean_pixel = tf.reshape(
      mean_pixels(model_variant), [1, 1, 3])
