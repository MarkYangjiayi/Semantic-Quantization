...
dataset_dir = "/Users/markyang/Quantization/WAGE-semantic/dataSet/ADEChallengeData2016/tfrecord"
...
def main():
  ...
  with tf.device('/cpu:0'):
    ...
    batchTest = input_generator.get(
        ...
        dataset_split=train_split,
        model_variant=model_variant)
    batchTrainX = batchTrain['image']
    batchTrainY = batchTrain['label']
    batchTestX = batchTest['image']
    batchTestY = batchTest['label']
    print batchTrainX
  numTrain = 20210
  numTest = 2000
  print(numTrain)
